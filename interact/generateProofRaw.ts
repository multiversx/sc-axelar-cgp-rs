import {
    Address,
    AddressValue,
    BigUIntValue, BinaryCodec,
    BytesValue, ContractFunction, H256Value,
    List,
    SmartContract,
    StringValue,
    Tuple
...
export async function executeGateway(
    ...
    const gatewayContract = new SmartContract({ address: Address.fromBech32('erd1qqqqqqqqqqqqqpgqsvzyz88e8v8j6x3wquatxuztnxjwnw92kkls6rdtzx') });
